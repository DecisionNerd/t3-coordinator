...
say ""
say "Paired testbed is the DecisionNerd/dev-skills git checkout as a T3 project — not craft skills on OVHC."
say "See: https://github.com/DecisionNerd/t3-coordinator/blob/main/docs/experience/TESTBED.md"
